...
namespace PivotForAimy.Models
{
    public partial class Attendance
    {
        public Attendance()
        {
            ...
            ModifiedAttendanceCost = new HashSet<ModifiedAttendanceCost>();
            RollCallHistory = new HashSet<RollCallHistory>();
            RollCallQueue = new HashSet<RollCallQueue>();
            UserDiscountAttendance = new HashSet<UserDiscountAttendance>();
        }
        ...
        public string SignOutNote { get; set; }
        public string SignInNote { get; set; }
        public bool? IsStaffSignIn { get; set; }
        public bool? IsStaffSignOut { get; set; }
        ...
        public virtual ICollection<ModifiedAttendanceCost> ModifiedAttendanceCost { get; set; }
        public virtual ICollection<RollCallHistory> RollCallHistory { get; set; }
        public virtual ICollection<RollCallQueue> RollCallQueue { get; set; }
        public virtual ICollection<UserDiscountAttendance> UserDiscountAttendance { get; set; }
